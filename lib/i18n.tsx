...
const translations: Record<Locale, any> = {
  cs: {
    ...
    colors: {
      ...
      swatches: [
        { name: 'Zelená', hex: '#687760' },
        { name: 'Starorůžová', hex: '#B06F72' },
        { name: 'Pudrově béžová', hex: '#E5D5CA' },
        { name: 'Teplá béžová', hex: '#C8AF93' },
        { name: 'Písková / zlatavě béžová', hex: '#B8A17E' },
  ...
  en: {
    ...
    colors: {
      ...
      swatches: [
        { name: 'Sage Green', hex: '#687760' },
        { name: 'Dusty Rose', hex: '#B06F72' },
        { name: 'Powder Beige', hex: '#E5D5CA' },
        { name: 'Warm Beige', hex: '#C8AF93' },
        { name: 'Sandy / Golden Beige', hex: '#B8A17E' },
