      ...
      days: [
        {
          ...
          schedule: [
            ...
            { time: '20:00 – 22:00', event: 'Večer s přáteli', icon: '🍻', desc: 'Nevěsta a ženich stráví část večera se svými nejbližšími přáteli. Pro ostatní bude připravena otevřená hospoda a volná zábava v areálu.' },
      ...
      days: [
        {
          ...
          schedule: [
            ...
            { time: '20:00 – 22:00', event: 'Evening with Friends', icon: '🍻', desc: 'The bride and groom will spend part of the evening with their closest friends. For everyone else, the pub stays open and the grounds are yours to enjoy.' },
