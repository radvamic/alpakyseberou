      ...
      days: [
        {
          ...
          schedule: [
            { time: '14:00', event: 'Příjezd hostů', icon: '🚗', desc: 'Ubytování a přivítání v areálu Hotelu Všetice' },
      ...
      days: [
        {
          ...
          schedule: [
            { time: '14:00', event: 'Guest Arrival', icon: '🚗', desc: 'Check-in and welcome at Hotel Všetice' },
