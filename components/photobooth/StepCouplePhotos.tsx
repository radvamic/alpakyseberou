  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="flex items-center gap-4">
        <div className="w-14 h-14 rounded-xl overflow-hidden border border-[#d8b28c]/30 shrink-0">
      ...
      >
        ...
        <motion.div
          className={`w-10 h-6 rounded-full p-0.5 transition-colors ${
            wantCouple ? 'bg-[#d8b28c]' : 'bg-[#2A2520]'
          }`}
        >
          <motion.div
              ...
              return (
                <motion.button
                  ...
                  className={`relative shrink-0 w-28 h-36 sm:w-32 sm:h-40 rounded-xl overflow-hidden border-2 transition-all duration-300 snap-start ${
                    isSelected
                      ? 'border-[#d8b28c] shadow-[0_0_15px_rgba(201,169,110,0.3)]'
                ...
                >
                  ...
                  {isSelected && (
                    <motion.div
                      className="absolute top-2 right-2 w-6 h-6 rounded-full bg-[#d8b28c] flex items-center justify-center"
                      initial={{ scale: 0 }}
                      animate={{ scale: 1 }}
                    >
