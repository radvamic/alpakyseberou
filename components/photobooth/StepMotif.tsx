      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
        {motifs.map((motif, i) => (
          <motion.button
            ...
            className="rounded-xl border border-[#2A2520] bg-[#1A1A1A] p-3 sm:p-4 text-center transition-all duration-300 hover:border-[#d8b28c]/40 hover:bg-[#d8b28c]/5 group min-h-[100px] flex flex-col items-center justify-center gap-2"
          ...
          >
            ...
            <h4 className="font-[family-name:var(--font-cormorant)] text-sm sm:text-base text-[#F5F0E8] group-hover:text-[#d8b28c] transition-colors leading-tight">
