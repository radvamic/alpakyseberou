...
export default function StepResult({
  ...
  return (
    <div className="flex flex-col items-center gap-5">
      ...
      {/* Generated image */}
      <motion.div
        className="relative w-full max-w-sm rounded-2xl overflow-hidden border-2 border-[#C9A96E]/30"
      ...
      <div className="flex flex-col sm:flex-row gap-3 w-full sm:w-auto">
        <button
          ...
          className="flex items-center justify-center gap-2 rounded-full border border-[#C9A96E] bg-[#C9A96E]/10 px-6 py-3 text-sm tracking-[0.1em] uppercase text-[#C9A96E] transition-all hover:bg-[#C9A96E]/20"
        >
        ...
        {!saved ? (
          ...
          <span className="flex items-center justify-center gap-2 px-6 py-3 text-sm text-[#C9A96E]">
            ...
            >
              ...
              <div className="space-y-4">
                ...
                <button
                  ...
                  className="w-full rounded-full border border-[#C9A96E] px-8 py-3 text-sm tracking-[0.15em] uppercase text-[#C9A96E] transition-all duration-500 hover:bg-[#C9A96E]/10 disabled:opacity-30 disabled:cursor-not-allowed"
                >
                  {saving
