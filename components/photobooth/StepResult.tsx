...
export default function StepResult({
  ...
  return (
    <div className="flex flex-col items-center gap-5">
      ...
      {/* Generated image */}
      <motion.div
        className="relative w-full max-w-sm rounded-2xl overflow-hidden border-2 border-[#d8b28c]/30"
      ...
      <div className="flex flex-col sm:flex-row gap-3 w-full sm:w-auto">
        <button
          ...
          className="flex items-center justify-center gap-2 rounded-full border border-[#d8b28c] bg-[#d8b28c]/10 px-6 py-3 text-sm tracking-[0.1em] uppercase text-[#d8b28c] transition-all hover:bg-[#d8b28c]/20"
        >
        ...
        {canShare && (
          <button
            onClick={handleShare}
            className="flex items-center justify-center gap-2 rounded-full border border-[#2A2520] px-6 py-3 text-sm text-[#B8A99A] transition-all hover:border-[#d8b28c]/30 hover:text-[#d8b28c]"
          >
            <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        ...
        {!saved ? (
          ...
          <span className="flex items-center justify-center gap-2 px-6 py-3 text-sm text-[#d8b28c]">
      ...
      <div className="flex flex-col sm:flex-row items-center gap-3 pt-2">
        {remaining > 0 && (
          <button
            ...
            className="text-sm text-[#B8A99A] hover:text-[#d8b28c] transition-colors"
          >
            ...
            >
              ...
              <div className="space-y-4">
                ...
                <div className="flex gap-3">
                  <button
                    ...
                    className={`flex-1 rounded-xl border px-3 py-3 text-center text-sm transition-all ${
                      savePublic
                        ? 'border-[#d8b28c] bg-[#d8b28c]/10 text-[#d8b28c]'
                        : 'border-[#2A2520] text-[#B8A99A] hover:border-[#d8b28c]/30'
                    }`}
                  >
                ...
                <button
                  ...
                  className="w-full rounded-full border border-[#d8b28c] px-8 py-3 text-sm tracking-[0.15em] uppercase text-[#d8b28c] transition-all duration-500 hover:bg-[#d8b28c]/10 disabled:opacity-30 disabled:cursor-not-allowed"
                >
                  {saving
