  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="flex flex-col gap-3">
        {categories.map((cat, i) => (
          <motion.button
            ...
            className="w-full rounded-xl border border-[#2A2520] bg-[#1A1A1A] p-4 sm:p-5 text-left transition-all duration-300 hover:border-[#d8b28c]/40 hover:bg-[#d8b28c]/5 group"
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1 min-w-0">
                <h4 className="font-[family-name:var(--font-cormorant)] text-lg sm:text-xl text-[#F5F0E8] group-hover:text-[#d8b28c] transition-colors">
              ...
              <svg className="w-5 h-5 text-[#2A2520] group-hover:text-[#d8b28c] transition-colors shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      ...
      <div className="pt-2">
        <button
          onClick={onBack}
          className="text-sm text-[#B8A99A] hover:text-[#d8b28c] transition-colors py-3"
        >
