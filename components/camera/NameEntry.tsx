        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <input
              ...
              maxLength={60}
              autoFocus
              className="w-full bg-[#141414] border border-[#2A2520] rounded-lg px-4 py-3 text-[#F5F0E8] placeholder-[#4A4540] focus:outline-none focus:border-[#B8A17E] transition-colors text-center text-lg"
            />
          </div>
          <motion.button
            type="submit"
            ...
            whileTap={{ scale: 0.97 }}
            className="w-full py-3 rounded-lg font-medium text-[#0A0A0A] bg-[#B8A17E] disabled:opacity-40 disabled:cursor-not-allowed transition-opacity text-lg"
          >
