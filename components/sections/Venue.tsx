...
export default function Venue() {
  ...
  const toggleBtn = (expanded: boolean, setExpanded: (v: boolean) => void, labelCs: string, labelEn: string) => (
  ...
  return (
    <section id="venue" className="relative pt-8 pb-6 md:pt-10 md:pb-8 bg-[#0A0A0A]">
      ...
      {toggleBtn(expandedVenue, setExpandedVenue, 'Zobrazit mapu', 'Show map')}
              ...
              >
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                  <a
                    ...
                    className="inline-flex items-center gap-2 rounded-full border border-[#d8b28c]/30 px-8 py-3 text-sm tracking-[0.15em] uppercase text-[#d8b28c] transition-all duration-500 hover:border-[#d8b28c] hover:bg-[#d8b28c]/10"
                  >
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-2 rounded-full border border-[#2A2520] px-8 py-3 text-sm tracking-[0.15em] uppercase text-[#B8A99A] transition-all duration-500 hover:border-[#d8b28c]/30 hover:text-[#f1d5c4]"
                  >
                    hotel-vsetice.cz
                  </a>
                </div>
      ...
      {/* ── Ubytování ── */}
      <div id="accommodation" className="mx-auto max-w-6xl px-6 mt-8">
        <SectionHeader
          title={locale === 'cs' ? 'Ubytování' : 'Accommodation'}
          subtitle={locale === 'cs' ? 'Hotel Všetice' : 'Hotel Všetice'}
        />
      </div>
      ...
      <div className="mx-auto max-w-6xl px-6 pb-8">
              ...
              <p className="text-center text-xs tracking-[0.25em] uppercase text-[#d8b28c]/60 mb-5 font-[family-name:var(--font-cormorant)]">
                ...
                {buildings.map((building, i) => (
                  <button
                    ...
                    className={`rounded-full px-5 py-2 text-xs tracking-[0.15em] uppercase transition-all duration-300 ${
                      activeBuilding === i
                        ? 'border border-[#d8b28c] bg-[#d8b28c]/10 text-[#d8b28c]'
                        : 'border border-[#2A2520] text-[#B8A99A] hover:border-[#d8b28c]/30'
                    }`}
                  >
                    {building.name}
                  </button>
                  ...
                  <div className="relative h-[300px] md:h-[450px]">
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-6 md:p-10">
                      <div className="flex items-center gap-3 mb-2">
                        ...
                        <span className="rounded-full border border-[#d8b28c]/50 bg-black/40 px-3 py-1 text-xs text-[#d8b28c]">
                          {buildings[activeBuilding].rooms}
                        </span>
                      </div>
                      <p className="text-xs uppercase tracking-[0.15em] text-[#d8b28c] mb-3 font-[family-name:var(--font-cormorant)] font-semibold" style={{textShadow: '0 1px 4px rgba(0,0,0,0.9)'}}>
                      ...
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-flex items-center gap-2 text-xs tracking-[0.15em] uppercase text-[#d8b28c] hover:text-[#e8c9a0] transition-colors"
                      >
