...
export default function WhyAlpacas() {
  ...
  return (
    <section id="alpacas" className="relative py-24 md:py-32 bg-[#0A0A0A] overflow-hidden">
      ...
      <div className="relative mx-auto max-w-2xl px-6 text-center">
        ...
        <AlpacaIllustration />
        <motion.p
          className="font-[family-name:var(--font-cormorant)] text-lg text-[#B8A99A] leading-relaxed mt-6"
