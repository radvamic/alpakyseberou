      ...
      <div className="mx-auto max-w-3xl px-6">
          ...
          {days.map((day, dayIndex) => (
            ...
            >
              ...
              <button
                ...
                className="w-full flex items-center justify-between gap-4 border border-[#2A2520] bg-[#0A0A0A]/60 px-6 py-5 hover:border-[#d8b28c]/30 transition-all duration-300 group"
              >
                <div className="flex items-center gap-4 text-left">
                  <span className="font-[family-name:var(--font-cormorant)] text-xs tracking-[0.2em] uppercase text-[#d8b28c]">
                    {day.label}
                  </span>
                  <span className="hidden sm:block h-px w-6 bg-[#2A2520] group-hover:bg-[#d8b28c]/30 transition-colors" />
                ...
                <motion.span
                  ...
                  className="text-[#d8b28c] text-sm flex-shrink-0"
                >
                  ↓
                </motion.span>
              </button>
                      ...
                      <div className="relative">
                        ...
                        <div className="space-y-5">
                          {day.schedule.map((item, i) => (
                            ...
                            >
                              <div className="relative z-10 flex h-11 w-11 flex-shrink-0 items-center justify-center rounded-full border border-[#d8b28c]/30 bg-[#141414] text-lg">
                                {item.icon}
                              </div>
                              <div className="flex-1 py-1">
                                <div className="flex items-baseline gap-3 mb-1 flex-wrap">
                                  <span className="font-[family-name:var(--font-playfair)] text-base text-[#d8b28c] font-medium whitespace-nowrap">
                                    {item.time}
                                  </span>
        ...
        >
          <button
            ...
            className="rounded-full border border-[#d8b28c]/30 bg-transparent px-8 py-3 text-sm tracking-[0.15em] uppercase text-[#d8b28c] transition-all duration-500 hover:border-[#d8b28c] hover:bg-[#d8b28c]/10"
          >
