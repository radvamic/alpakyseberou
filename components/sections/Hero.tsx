  ...
  return (
    <section id="hero" className="relative h-screen w-full overflow-hidden">
      ...
      <div className="relative z-10 flex h-full flex-col items-center justify-center px-4">
        ...
        {/* Date */}
        <motion.p
          className="mt-6 sm:mt-8 font-[family-name:var(--font-cormorant)] text-lg sm:text-xl md:text-2xl tracking-[0.3em] text-[#E8D5B5] uppercase"
        ...
        >
          {countdownItems.map((item, i) => (
            <div key={i} className="flex flex-col items-center">
              <span className="font-[family-name:var(--font-playfair)] text-3xl sm:text-4xl md:text-5xl font-light text-[#C9A96E]">
                {String(item.value).padStart(item.label === (t('hero.days') as string) ? 3 : 2, '0')}
              </span>
        ...
        >
          <a
            href="#story"
            className="font-[family-name:var(--font-cormorant)] text-sm tracking-[0.2em] uppercase text-[#B8A99A] hover:text-[#C9A96E] transition-colors"
          >
