  ...
  return (
    <footer className="relative py-16 md:py-24 bg-[#0A0A0A]">
      ...
      <div className="mx-auto max-w-4xl px-6 text-center">
        ...
        >
          <span className="font-[family-name:var(--font-great-vibes)] text-3xl text-[#d8b28c]">
            K & M
          </span>
        </motion.div>

        {/* Divider */}
        <div className="mx-auto mb-8 h-[1px] w-32 bg-gradient-to-r from-transparent via-[#d8b28c]/30 to-transparent" />
        ...
        <motion.button
          onClick={scrollToTop}
          className="mt-10 inline-flex items-center gap-2 text-xs tracking-[0.2em] uppercase text-[#B8A99A] hover:text-[#d8b28c] transition-colors"
          whileHover={{ y: -2 }}
        >
